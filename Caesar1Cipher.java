...
public class Caesar1Cipher extends JFrame
{
...
//
	...
	public Caesar1Cipher() // constractor class 
	{
   ...
   programVsion.addMouseListener(new MouseAdapter() 
	...
	JOptionPane.showMessageDialog(null," \n three step Caesar cipher - version 1.00 - \n 07/2019 \n ;-) \n ","INFORMATION MESSAGE",JOptionPane.INFORMATION_MESSAGE);
   ...
   technologyUSED.addMouseListener(new MouseAdapter() 
	...
	createFile.setToolTipText("cipher compilation button");
	  ...
	  createFile.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				for(int i=0;i<JTextAreaCarrier.length;i++)
				{
					...
					StringToCharCarrier = JTextAreaCarrier[0].toCharArray();
							...
							// null carrier ..... 
									...
									//	char c2=LatinLowerCase[k].charAt(0);  .... not count ....
										...
										if(LatinUpperCase[k].charAt(0) == StringToCharCarrier[j])
										{
										 ...
										 if(LatinLowerCase[k].charAt(0) == StringToCharCarrier[j])
										{
 										 ...
 										 if( ( k == ( LatinUpperCase.length-1 ) ) && ( LatinUpperCase[k].charAt(0) != StringToCharCarrier[j] )  && ( LatinLowerCase[k].charAt(0) != StringToCharCarrier[j] )    )
										{
...
2016/11/16
	...
	Format formatter = new SimpleDateFormat("YYYY-MM-dd_hh-mm-ss");
				...
				String sometext=FILEname+"three.step.ceasar.cipher."+(formatter.format(date))+".txt";
	...
	//
		...
		JFrame frame=new JFrame(" three shift Caesar cipher - version 1.00 - ");
		frame.add(box);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void main(String [] Caesar1Cipher)
	{
